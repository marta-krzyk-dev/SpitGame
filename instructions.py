def getInstructions():
    return {
        'Setup': 'Place five cards face down in a row. Add a second card to piles two through five. Add a third card to piles three through five. Add a fourth card to piles four and five. Add a fifth card to pile five. Flip the top card in each pile face up. The remaining cards in your hand are known as your spit pile.',
...
",
        'Rules': 'If both players cannot play, and neither player has a spit pile left, the round is over. Players will slap a middle pile of cards to take for the next round.\n\
If a player can put a card into either spit pile, the left spit pile will be chosen.\n\
If there are duplicate cards that can be put into a spit pile, the leftmost duplicate will be drawn.'
    }
